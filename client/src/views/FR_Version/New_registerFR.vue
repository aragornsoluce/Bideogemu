      ...
      <section class="auth-section">
        <div class="register-form">
          ...
          <form @submit.prevent="register">
            <input type="text" v-model="registerUsername" placeholder="Nom d'utilisateur" required />
            <input type="password" v-model="registerPassword" placeholder="Mot de passe" required />
